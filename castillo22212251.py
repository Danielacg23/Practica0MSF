...
kP,kI,kD = 289.680927538353, 7062.47058056347, 0.391371372630429
Cr = 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
...
print (f"El valor de la capcitancia de Ce es de: {Ce} Faradios.")

numPID = [Rr*Re*Cr*Ce,Re*Ce+Rr*Cr,1]
denPID = [Re*Cr,0]
PID = ctrl.tf(numPID,denPID)
print (f"La función de transferencia del controlador PID es {PID}")
...
fg2 = plt.figure()
plt.plot(t,u2,'-',color = clr2,label = 'Pao(t)')
